...
*Note - income data wasn't available for 15% of the museums and they aren't included in the charts below.*
...
data %>%
  ...
  geom_col() +
  scale_x_discrete("Income Category") +
  scale_y_continuous("Grant Funds", # change y-axis label
                   labels = scales::label_dollar() # reformat y-axis to $ with commas
                   ) +
  scale_fill_discrete(labels = c("$0", 
                               "$1 - $9,999", 
                               "$10,000 - $24,999", 
                               "$25,000 - $99,999",
                               "$100,000 - $499,999", 
