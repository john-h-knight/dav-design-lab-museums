...
Isolating each program confirms that the top three programs skew towards higher income levels. The *Inspire! Grants for Small Museums* program, which does not require matching funds, was awarded to museums with mid-range and lower income levels. This could be explained
